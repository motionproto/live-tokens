...
| DESIGN.md | `catalogue` entries (`description`, `useFor`, `notFor`, `props`), nine skills, the pick-component decision tests, and checker rules | The intent exists, but only as Svelte module scripts and Claude Code skills |
