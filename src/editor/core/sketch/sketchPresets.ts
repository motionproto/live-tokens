...
export const SKETCH_PRESETS: Record<string, SketchSettings> = {
  ...
  marker: {
    ...
    pressure: 0.2, pressureMod: 0.25, pooling: 2,
  },
  ...
  whiteboard: {
    ...
    pressure: 0.15, pressureMod: 0.15, pooling: 3.5,
  },
  ...
  hachure: {
    ...
    pressure: 0.3, pressureMod: 0.45, pooling: 0.8,
  },
  ...
  wireframe: {
    ...
    pressure: 0.1, pressureMod: 0.1, pooling: 0,
  },
  ...
  napkin: {
    ...
    pressure: 0.45, pressureMod: 0.6, pooling: 2.5,
  },
  ...
  dry: {
    ...
    pressure: 0.4, pressureMod: 0.7, pooling: 1.5,
  },
};
