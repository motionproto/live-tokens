...
/**
 * The overlay the stateful suites drive. It opens from the repo's own demo
 * page, so it stays out of `src/testing`: a consumer's project has neither the
 * route nor the button.
 */
