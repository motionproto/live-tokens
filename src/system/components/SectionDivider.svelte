...
<style>
  ...
  :global(:root) {
    ...
    --sectiondivider-lg-description-line-height: var(--line-height-normal);
    ...
    --sectiondivider-md-description-line-height: var(--line-height-normal);
    ...
    --sectiondivider-sm-description-line-height: var(--line-height-normal);
