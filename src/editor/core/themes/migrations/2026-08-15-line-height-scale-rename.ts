 ...
 * vocabulary. That pass renames the definitions in `tokens.css`; a saved
 * colors-and-type file still references the old names, and a reference to a
 * token that no longer exists renders as nothing.
 *
 ...
 *
 * Values alone, never keys: a key is a definition, and remapping
 * `--line-height-xl` onto `--line-height-relaxed` would redefine a surviving
 * step at 2 for everything that references it.
 */
...
export const colorsAndTypeMigration_2026_08_15_lineHeightScaleRename: Migration = {
  id: '2026-08-15-line-height-scale-rename',
  fromVersion: 4,
  toVersion: 5,
