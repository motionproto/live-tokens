...
<style lang="scss">
  ...
  :global(:root) {
    ...
    --menuselect-default-text-line-height: var(--line-height-tight);
    ...
    --menuselect-hover-text-line-height: var(--line-height-tight);
    ...
    --menuselect-selected-text-line-height: var(--line-height-tight);
    ...
    --menuselect-disabled-text-line-height: var(--line-height-tight);
