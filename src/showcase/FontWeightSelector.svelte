...
<div class="font-weight-selector" bind:this={container}>
  <button class="selector-trigger" on:click={toggle}>
    <div class="trigger-preview" style="font-weight: {currentWeight || 'inherit'};">A</div>
    <div class="trigger-text">
      {#if activeLabel}
        <span class="trigger-category">{activeLabel}</span>
      {/if}
      <span class="trigger-subtype">{currentWeight || '—'}</span>
    </div>
    ...
    <div class="selector-dropdown">
      ...
      <div class="option-list">
        {#each options as opt}
          ...
          >
            <span class="option-preview" style="font-weight: var(--font-weight-{opt.key});">A</span>
            <span class="option-label">{opt.label}</span>
            <code class="option-size">{opt.weight}</code>
          </button>
        {/each}
      </div>
    </div>
