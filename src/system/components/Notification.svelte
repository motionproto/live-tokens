...
<style lang="scss">
   ...
   :global(:root) {
      ...
      --notification-info-title-font-size: var(--font-size-md);
      ...
      --notification-success-title-font-size: var(--font-size-md);
      ...
      --notification-warning-title-font-size: var(--font-size-md);
      ...
      --notification-danger-title-font-size: var(--font-size-md);
